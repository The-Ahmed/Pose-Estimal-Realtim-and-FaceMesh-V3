...
pTime = 0
detector1 = pm.poseDetector(detectionCon=0.7) # Pose
#detector2 = fmm.FaceMeshDetector(maxFaces=1) #FaceMesh
...
while True:
    ...
    #Find Pose and Face
    img = detector1.findPose(img) #Pose
    #img, faces = detector2.findFaceMesh(img) #FaceMesh
